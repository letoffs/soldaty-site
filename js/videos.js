...
const videosData = [
    ...
    { id: 8, title: "Анонс сериала Солдаты-13", desc: "Анонс тринадцатого сезона сериала «Солдаты». Проморолик с песней «Юность в сапогах» в исполнении актёров сериала.", youtubeId: "y6WBQMK296Q", duration: "1:30", year: "2007", category: "trailer" },
    { id: 9, title: "Анонс сериала Солдаты. Новый призыв", desc: "Анонс пятнадцатого сезона с телеканала Рен ТВ.", youtubeId: "G4s4WnHAQLE", duration: "1:30", year: "2008", category: "trailer" },
    // Клипы и нарезки
    { id: 10, title: "Конец Фильма — Юность в сапогах", desc: "Клип на песню «Юность в сапогах» группы «Конец Фильма».", youtubeId: "Lgr5AhsgDLk", duration: "3:08", year: "2004", category: "clip" },
    { id: 11, title: "Солдаты(2 рота) — Юность в сапогах", desc: "Клип на песню «Юность в сапогах» с кадрами из сериала про 2-ю роту.", youtubeId: "zSGuZo0TXKU", duration: "2:01", year: "2004", category: "clip" },
    { id: 12, title: "Солдаты — Песня прапорщика Шматко «Не грусти»", desc: "Легендарная песня в исполнении Алексея Маклакова. «А прапорщик Шматко — это зверь, а не мужик!»", youtubeId: "qP1r5eOWNeA", duration: "2:00", year: "2008", category: "clip" },
    { id: 13, title: "Солдаты — Есть только миг", desc: "Душевная песня из спин-оффа «Новый год, твою дивизию» 2 серия. Отрывок, который трогает до глубины души.", youtubeId: "qirBsztWqWo", duration: "2:51", year: "2007", category: "clip" },
    { id: 14, title: "Солдаты — Три белых коня", desc: "Песня «Три белых коня» из спин-оффа «Новый год, твою дивизию» 1 серия. Новогоднее настроение по-армейски!", youtubeId: "J1XIfQkJHa0", duration: "2:48", year: "2007", category: "clip" },
    { id: 15, title: "Солдаты — Песня про зайцев", desc: "Знаменитая песня про зайцев из спин-оффа «Новый год, твою дивизию» 2 серия. «А нам всё равно, а нам всё равно...»", youtubeId: "mO4DaXcvxv0", duration: "2:34", year: "2007", category: "clip" },
    { id: 16, title: "Солдаты — Мурка", desc: "Песня «Мурка, ты мой мурёночек» из спин-оффа «Новый год, твою дивизию» 1 серия. Легендарный блатняк в армейской обработке!", youtubeId: "As2yFhGKL6E", duration: "3:02", year: "2007", category: "clip" },
    { id: 17, title: "Маклаков и 23 февраля - Когда поют солдаты", desc: "В концерте прозвучат песни из сериала Солдаты. Участвуют: Конец Фильма с композицией Юность в Сапогах, Дмитрий Маликов, Отпетые Машенники, БИ-2, Олег Газманов, Юта, а также несколько песен исполнит легендарный прапорщик Шматко (Алексей Маклаков). Увидите кадры из сериала Прапорщик. Концерт ведут: Зубов (Алексей Ошурков), Замполит Староконь (Вячеслав Гришечкин), Цлав (Руслан Сасин), Кот (Артем Григорьев), прапорщик Соколов (Иван Моховиков) и др.", youtubeId: "U-Bb6sOjqes", duration: "1:04:00", year: "2007", category: "clip", requiresAuth: true},
    // Закулисье
    { id: 18, title: "Солдаты — закулисье", desc: "Неформальные моменты со съемочной площадки. Курение, алкоголь, нецензурная лексика.", youtubeId: "HnPzAy8ylNg", duration: "23:38", year: "2007", category: "behind", is18Plus: true },
    { id: 19, title: "Солдаты — съёмочная группа", desc: "Актёры о съёмках и своих персонажах. Эксклюзивные закулисные истории.", youtubeId: "JMbIM0RKIV8", duration: "7:09", year: "2011", category: "behind" },
    { id: 20, title: "Турчинский за кадром сериала Солдаты", desc: "Уникальные закадровые съёмки и интервью с создателями сериала «Солдаты». Режиссёр, актёры и, конечно, легендарный ведущий Иван Турчинский за работой.", youtubeId: "SKgkjpOmSQ8", duration: "4:16", year: "2008", category: "behind" },
    // Пародии (новая категория)
    { id: 21, title: "Большая Разница — Шматко на шоу Интуиция (пародия)", desc: "Легендарная пародия от шоу «Большая Разница». Прапорщик Шматко в образе участника шоу «Интуиция». Алексей Маклаков в роли самого себя!", youtubeId: "l4IaVDIm_Ck", duration: "6:29", year: "2009", category: "parody" },
    { id: 22, title: "Большая Разница — Солдаты Римской империи (пародия)", desc: "Гениальная пародия от шоу «Большая Разница»! Если бы сериал «Солдаты» снимали во времена Римской империи. Легионеры, центурионы и... прапорщик Шматко по-римски!", youtubeId: "mRgplRji4es", duration: "7:41", year: "2009", category: "parody" },
    // Дембели
    { id: 23, title: "ДМБ 2004", desc: "2 сезон 1 серия. Дембель солдат призыва 2002 года: Евсеев, Сухачев, Прохоров и Фомин", youtubeId: "4O55MEWFuSw", duration: "4:16", year: "2004", category: "dembel" },
];
