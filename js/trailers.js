...
const trailersData = [
    ...
    {
        id: 3,
        title: "Солдаты — 10 лет спустя",
        desc: "Юбилейный ролик к 10-летию сериала. Воспоминания актёров и съёмочной группы.",
        youtubeId: "TREYLER_ID_3",
        duration: "2:15",
        year: "2014"
    },
    {
        id: 4,
        title: "Лучшие цитаты из «Солдаты»",
        desc: "«Ё-моё!», «Настоящий полковник!» и другие легендарные фразы из сериала.",
        youtubeId: "TREYLER_ID_4",
        duration: "2:50",
        year: "2006"
    },
    {
        id: 5,
        title: "Персонажи сериала «Солдаты»",
        desc: "Знакомство с главными и второстепенными героями культового армейского сериала.",
        youtubeId: "TREYLER_ID_5",
        duration: "2:30",
        year: "2004"
    },
    {
        id: 6,
        title: "Солдаты — за кадром",
        desc: "Как снимался сериал. Интервью с актёрами и съёмочной группой.",
        youtubeId: "TREYLER_ID_6",
        duration: "4:00",
        year: "2007"
    }
];
